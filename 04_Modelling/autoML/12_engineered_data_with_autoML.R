...
# Load data
diabetes_train <- read_rds("00_Data/processed/for_analysis/diabetes_engineered_filtered_train.rds")

# Run autoML algorithm  ----

## Specification: Engineered dataset
...
map2(best_fit_by_model_type$model,
     ...
     save_h2o_model,
     path = "04_Modelling/models/engineered_autoML_models/")